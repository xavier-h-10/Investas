...
import {getFundPortfolio} from "../../service/FundPortfolioService";
...
export default class FusionTreeMap extends Component {
  constructor(props) {
    ...
    // }
    //
    // getFundPortfolio(props.code, this.receiveData);

    if (props.data == undefined || props.data == null) {
      return;
    }
    this.receiveData(props.data);
  }

  receiveData = (data) => {
    // if (data.data.fundPortfolioList == undefined || data.data.fundPortfolioList
    //     == null || data.data.fundPortfolioList.length == 0) {
    //   return;
    // }
    // let datas = data.data.fundPortfolioList;
    let datas = data;
