...
import { deleteJob, queryJobStatus } from '@/pages/dashboard/monitor/service';
  ...
  const columns: ProColumns<JobType>[] = [
    ...
    },
    {
      ...
      valueEnum: {
        ...
        PredictionUpdate: <Badge color="grey" text="更新预测数据" />,
  ...
  return (
    <>
      <EditableProTable<JobType>
        rowKey="fundType"
        headerTitle="交我赚 服务器并行高性能任务列表"
        tooltip="在此您可以查看交我赚后台的执行任务的线程表，了解所有流水线执行的任务的工作状态。"
        maxLength={15}
        columns={columns}
        value={dataSource}
